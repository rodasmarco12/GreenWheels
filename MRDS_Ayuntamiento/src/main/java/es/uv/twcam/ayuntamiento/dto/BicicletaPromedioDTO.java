...
public class BicicletaPromedioDTO {
    private String id;
    ...
    public BicicletaPromedioDTO() {
    }

    public BicicletaPromedioDTO(String id, double avgBikesAvailable, float latitude, float longitude) {
        this.id = id;
